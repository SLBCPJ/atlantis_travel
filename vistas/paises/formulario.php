        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header" style="text-align: center">
                    <strong>REGISTRO DE PAIS</strong>
                </div>
                    ...
                    <form action="PaisControlador.php" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row form-group">
                            <div class="col-12 col-md-12">
                                ...
                                <input type="text" id="nombre" name="nombre" placeholder="Nombre Pais"
                        ...
                        <div class="row form-group">
                            <div class="col-12 col-md-12">
                                ...
                                <textarea name="descripcion" id="descripcion" rows="4" placeholder="Descripción..."
