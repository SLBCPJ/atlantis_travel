        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="PaisControlador.php" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row form-group">
                            <div class="col-12 col-md-12">
                                ...
                                <input type="text" id="nombre" name="nombre" class="form-control"
                                    value="<?php echo $actualizar->nombre_pais;?>" required>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-12 col-md-12">
                                <label class=" form-control-label">Descripción</label>
                                <textarea type="text" id="descripcion" name="descripcion" rows="4" class="form-control"
                                    required><?php echo $actualizar->descripcion_pais;?></textarea>
                            </div>
...
<script>
    ...
    $("#validacion").validate({
        ...
        messages: {
            nombre: {
                required: "Por Favor Ingrese El nombre del transporte a actualizar",
                minlength: jQuery.validator.format("al menos {0} caracteres son necesarios!"),
                maxlength: "Maximos caracteres permitidos: 30"
            },
            descripcion: {
                required: "Por Favor Ingrese una descripcion del transporte a actualizar",
                minlength: jQuery.validator.format("al menos {0} caracteres son necesarios!"),
