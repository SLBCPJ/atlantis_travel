...
class TransporteControlador extends Transporte{
    ...
    public function verificacionmostrar(){
        ...
        require '../vistas/transporte/mostrar.php';
    }
    public function insertartransportes(){
        // echo "Estamos llegando a la funcion Insertar";
        require '../vistas/transporte/formulario.php';
    }
    public function verificacionactualizar($id){
        $this->id = $id;
        $objetoretornado = $this->actualizar();
       
        require '../vistas/transporte/actualizar.php';
    }
    ...
    public function redireccionar(){
        header("location: TransporteControlador.php?accion=mostrar");
    }
 ...
 if (isset($_SESSION['email']) && ($_SESSION['rol'] == "Cliente")){  
    if (isset($_GET['accion']) && $_GET['accion']=="mostrar") {
        $instanciacontrolador = new TransporteControlador();
   ...
   if (isset($_SESSION['email']) && ($_SESSION['rol'] == "Administrador")){  
    if (isset($_GET['accion'])&&$_GET['accion']=="insertar") {
        $instanciacontrolador = new TransporteControlador();
        $instanciacontrolador->insertartransportes();
    }
